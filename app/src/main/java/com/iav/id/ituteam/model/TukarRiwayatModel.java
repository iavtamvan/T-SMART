...
public class TukarRiwayatModel{
	...
	@SerializedName("id_tukar_barang_riwayat")
	private String idTukarBarangRiwayat;

	@SerializedName("tgl_penukaran_brang")
	private String tglPenukaranBrang;
	...
	public void setIdTukarBarangRiwayat(String idTukarBarangRiwayat){
		this.idTukarBarangRiwayat = idTukarBarangRiwayat;
	}

	public String getIdTukarBarangRiwayat(){
		return idTukarBarangRiwayat;
	}

	public void setTglPenukaranBrang(String tglPenukaranBrang){
		this.tglPenukaranBrang = tglPenukaranBrang;
	}

	public String getTglPenukaranBrang(){
		return tglPenukaranBrang;
	}
